...
import os
import torch
from exp.exp_forecasting_Sumba import Exp_Long_Term_Forecast
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Sumba')

    # basic config
    parser.add_argument('--task_name', type=str, required=True, default='long_term_forecast')
    parser.add_argument('--is_training', type=int, required=True, default=1, help='status')
    parser.add_argument('--model_id', type=str, required=True, default='test', help='model id')
    parser.add_argument('--model', type=str, required=True, default='Sumba')
    ...
    parser.add_argument('--label_len', type=int, default=84, help='start token length')
    ...
    parser.add_argument('--dimension', type=int, default=32, help='D')
    parser.add_argument('--kernel_set', type=list, default=[2,3,6,7], help='the kernel set in TCN')  #[11,13,17,21]  [2, 3, 6, 7]
    parser.add_argument('--sumba_layers', type=int, default=3)
